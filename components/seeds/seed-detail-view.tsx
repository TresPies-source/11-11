  ...
  return (
    ...
    >
      ...
      <div className="bg-card border border-border rounded-lg overflow-hidden flex-1 flex flex-col">
        <div className="bg-bg-primary border-b border-border p-6">
          ...
          <section className="pt-4 border-t border-border">
            <div className="grid grid-cols-2 gap-4 text-sm">
              ...
              {seed.replanted && (
                <>
                  <div>
                    <span className="text-text-muted block mb-1">Replanted</span>
        ...
        <div className="sticky bottom-0 bg-bg-primary border-t border-border p-6">
